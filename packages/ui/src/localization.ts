...
const simplifiedChinese: Readonly<Record<string, string>> = Object.freeze({
    ...
    'Cell HTML': '单元格 HTML',
    'Cell height': '单元格高度',
    'Cell height unit': '单元格高度单位',
    'Cell padding': '单元格内边距',
    'Cell properties': '单元格属性',
    'Cell spacing': '单元格间距',
    'Cell width': '单元格宽度',
    'Cell width unit': '单元格宽度单位',
    ...
    'Row span': '行跨度',
    Section: '分区',
    'Section properties': '分区属性',
    Summary: '摘要',
    'Table height': '表格高度',
    'Table height unit': '表格高度单位',
    'Table width': '表格宽度',
    'Table width unit': '表格宽度单位',
    Top: '顶部',
    'Width unit': '宽度单位',
    ...
    'Named anchor': '命名锚点',
    'New paragraph: Enter': '新建段落：Enter',
    ...
    'Preset colors': '预设颜色',
    'Remove image': '移除图片',
    'Responsive CSS classes': '响应式 CSS 类',
    'Responsive image settings': '响应式图片设置',
    'Responsive sizes': '响应式尺寸规则',
    'Responsive sources': '响应式图片源',
    'Size and placement': '尺寸与位置',
...
const traditionalChinese: Readonly<Record<string, string>> = Object.freeze({
    ...
    'Cell HTML': '儲存格 HTML',
    'Cell height': '儲存格高度',
    'Cell height unit': '儲存格高度單位',
    'Cell padding': '儲存格內邊距',
    'Cell properties': '儲存格屬性',
    'Cell spacing': '儲存格間距',
    'Cell width': '儲存格寬度',
    'Cell width unit': '儲存格寬度單位',
    ...
    'Row span': '列跨度',
    Section: '區段',
    'Section properties': '區段屬性',
    Summary: '摘要',
    'Table height': '表格高度',
    'Table height unit': '表格高度單位',
    'Table width': '表格寬度',
    'Table width unit': '表格寬度單位',
    Top: '頂端',
    'Width unit': '寬度單位',
    ...
    'Named anchor': '命名錨點',
    'New paragraph: Enter': '新增段落：Enter',
    ...
    'Preset colors': '預設顏色',
    'Remove image': '移除圖片',
    'Responsive CSS classes': '響應式 CSS 類別',
    'Responsive image settings': '響應式圖片設定',
    'Responsive sizes': '響應式尺寸規則',
    'Responsive sources': '響應式圖片來源',
    'Size and placement': '尺寸與位置',
