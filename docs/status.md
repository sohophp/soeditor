...
The `1.2.1` release is owner-authorized on 2026-09-08 and all 24 manifests are aligned. Publication and public verification are tracked by the protected npm workflow; local builds are not a registry publication claim.

The CMS ESM initialization patch is documented in [1.2.1](releases/1.2.1.md).
