...
This site uses the `soeditor-release` npm alias to pin the published package without monorepo source linking. Normal applications can use the original package name.
