...
description: Edit text and read HTML to inspect heading and table semantics.
---

# Minimal editor

Edit text and read HTML to inspect heading and table semantics.

<EditorDemo example="basic" />

## What to verify

Edit text and read HTML to inspect heading and table semantics. Read HTML displays canonical content. Recreate demo destroys and remounts the instances. Upload and save send no editing content; mock uploads return the bundled image.
