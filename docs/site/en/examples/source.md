...
description: Switch to Source, side-by-side and stacked views, then return to WYSIWYG.
---

# WYSIWYG + Source

Switch to Source, side-by-side and stacked views, then return to WYSIWYG.

<EditorDemo example="source" />

## What to verify

Switch to Source, side-by-side and stacked views, then return to WYSIWYG. Read HTML displays canonical content. Recreate demo destroys and remounts the instances. Upload and save send no editing content; mock uploads return the bundled image.
