...
| 入口                     | 状态与说明                                          |
| ------------------------ | --------------------------------------------------- |
| `@soeditor/editor/video` | 显式插件兼容入口；1.4.0 默认视频通过 `video` 配置。 |
| `@soeditor/react/cms`    | 1.4.0 CMS 组件；使用 `value/onChange`。             |
| `@soeditor/vue/cms`      | 1.4.0 CMS 组件；支持 `v-model`。                    |

[React 指南](/zh-CN/guide/react) · [Vue 指南](/zh-CN/guide/vue) · [视频指南](/zh-CN/guide/video)。框架示例使用 npm 1.4.0 发布包。
