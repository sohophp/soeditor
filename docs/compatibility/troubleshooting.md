# Troubleshooting — repository compatibility reference

This repository-only reference describes historical modular and compatibility integrations. For the pinned public CMS release, use the [bilingual documentation site](../site/en/guide/installation.md). It is not published or indexed by the site.
