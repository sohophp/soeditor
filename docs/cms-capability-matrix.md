...
| Cross-browser CMS qualification  | Chromium, Firefox, and WebKit qualified | 48           | 6 Chromium CMS runs plus 96/96 applicable Firefox/WebKit runs in the official Playwright image |
