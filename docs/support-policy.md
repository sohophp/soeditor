...
| Firefox                                    | Qualified by the focused CMS and direct WYSIWYG matrix in the official Playwright Linux image; the Rocky Linux workstation itself remains host-blocked |
| WebKit                                     | Qualified by the focused CMS and direct WYSIWYG matrix in the official Playwright Linux image                                                          |
| Safari                                     | Real Safari qualification remains pending; passing Playwright WebKit is supporting evidence, not a Safari sign-off                                     |
